...
# -*- coding: utf-8 -*-
"""
Created on Wed Oct  3 13:35:37 2018
...
from os import path
from dataset_utils import _get_dataset_dir, _fetch_file
...
def fetch_GloVe(dim=300, corpus="wiki-6B", normalize=True, lower=False, 
                clean_words=False):
    """
...
def fetch_SG_GoogleNews(normalize=True, lower=False, clean_words=False):
    ...
    """
    path = _fetch_file(url="https://s3.amazonaws.com/dl4j-distribution/GoogleNews-vectors-negative300.bin.gz",
                           data_dir="embeddings",
                           verbose=1)
    return load_embedding(path, format="word2vec_bin", normalize=normalize, 
                          lower=lower, 
